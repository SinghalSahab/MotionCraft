  ...
  return (
    ...
    id='contact'>
        <div className='relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'>
            ...
            <ImageClipBox clipClass="contact-clip-path-2 lg:tranlate-y-40 translate-y-60"
            src="img/contact-2.webp" /> 
            </div>
            
            <div className='absolute -top-40 left-20  w-60 md:left-auto md:right-10
            sm:top-1/2 lg:top-20 lg:w-80 '>
