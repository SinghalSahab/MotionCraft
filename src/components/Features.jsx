        ...
        <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden
         ...
         <div className='grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7'>
            ...
            <BentoTilt className='bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0'>
                ...
                title={<>n<b>e</b>xus</>}
                description="a gamified social hub, adding a new dimension of play to socail interaction for Web3 communities."
                isComingSoon/>
            </BentoTilt>
          ...
          />
             ...
             <BentoTilt className='beto-tilt_2'>
                <div className='flex size-full flex-col justify-between
                bg-violet-300 p-5'>
                    <h1 className='bento-title special-font max-w-64 text-black'>
                        M<b>o</b>re co<b>m</b>ing s<b>oo</b>n!</h1>
